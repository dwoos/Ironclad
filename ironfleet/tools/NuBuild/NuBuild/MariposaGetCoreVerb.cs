...
using System.IO;
    ...
    internal class MariposaGetCoreVerb
        : Verb, IProcessInvokeAsyncVerb
    {
        ...
        private static SourcePath getMariposaExecutable()
        {
            ...
            if (MariposaGetCoreVerb.MariposaExecutable == null)
            {
                MariposaGetCoreVerb.MariposaExecutable = new SourcePath("tools\\Mariposa\\Mariposa.exe", SourcePath.SourceType.Tools);
            }

            return MariposaGetCoreVerb.MariposaExecutable;
        }
