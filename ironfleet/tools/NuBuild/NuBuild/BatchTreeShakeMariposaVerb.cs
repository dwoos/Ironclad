...
namespace NuBuild
{
    ...
    using System.IO;
    using System.Linq;
    class BatchTreeShakeMariposaVerb 
        : Verb
    {
        ...
        public BatchTreeShakeMariposaVerb(SourcePath batch_file)
        {
            ...
            foreach (string line in File.ReadAllLines(IronRootDirectory.PathTo(batch_file)))
            {
                ...
                this.upstream.Add(new MariposaTreeShakeVerb(src, prohibited_id, args));
            }
