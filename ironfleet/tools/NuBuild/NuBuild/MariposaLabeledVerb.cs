...
using System.IO;
    ...
    internal class MariposaLabeledVerb
        : Verb, IProcessInvokeAsyncVerb
    {
        ...
        public MariposaLabeledVerb(BuildObject MariposaInput)
        {
            ...
            this.outputFile = MariposaInput.makeOutputObjectWithDirname("labeled");
        }
        ...
        private static SourcePath getMariposaExecutable()
        {
            ...
            if (MariposaLabeledVerb.MariposaExecutable == null)
            {
                MariposaLabeledVerb.MariposaExecutable = new SourcePath("tools\\Mariposa\\Mariposa.exe", SourcePath.SourceType.Tools);
            }

            return MariposaLabeledVerb.MariposaExecutable;
        }
