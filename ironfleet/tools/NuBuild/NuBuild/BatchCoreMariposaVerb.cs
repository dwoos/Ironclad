...
namespace NuBuild
{
        ...
        : Verb
    {
        ...
        public BatchCoreMariposaVerb(SourcePath batch_file)
        {
            ...
            foreach (string line in File.ReadAllLines(IronRootDirectory.PathTo(batch_file)))
            {
                ...
                IEnumerable<string> args = new ArraySegment<string>(words, 1, words.Length - 1);
                this.upstream.Add(new MariposaCoreVerb(src, args));
            }
