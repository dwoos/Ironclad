...
using System.IO;
    ...
    internal class MariposaTreeShakeVerb
        : Verb, IProcessInvokeAsyncVerb
    {
        ...
        public MariposaTreeShakeVerb(BuildObject MariposaInput, string prohibited_id, IEnumerable<string> prohibited_constants)
        {
            ...
            this.outputFile = MariposaInput.makeOutputObjectWithDirname("shook" + "-" + prohibited_id);
        }
        ...
        private static SourcePath getMariposaExecutable()
        {
            ...
            if (MariposaTreeShakeVerb.MariposaExecutable == null)
            {
                MariposaTreeShakeVerb.MariposaExecutable = new SourcePath("tools\\Mariposa\\Mariposa.exe", SourcePath.SourceType.Tools);
            }

            return MariposaTreeShakeVerb.MariposaExecutable;
        }
